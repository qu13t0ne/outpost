...
- **Apps and Services**
   ...
   - [Syncthing](./syncthing/) - File synchronization service for the default Docker-network setup; see [Syncthing host-network](./syncthing-host-network/) for the host-network variant
